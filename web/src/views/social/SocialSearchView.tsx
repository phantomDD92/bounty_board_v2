...
// Lib Imports
import { getSocialList } from '@/lib/api'
...
const SocialSearchView = () => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <div className='flex flex-wrap sm:items-center justify-between max-sm:flex-col gap-6'>
          <div>
            ...
            <Typography>Find and explore socials of bounty board</Typography>
          </div>
      ...
      <Grid item xs={12}>
        <Card>
          <CardHeader title='Social List' subheader={`Total ${data.length} socials founded`} />
          <CardContent className='flex flex-col gap-6'>
            {data.length > 0 ? (
              ...
              <Typography className='text-center'>No socials found</Typography>
            )}
