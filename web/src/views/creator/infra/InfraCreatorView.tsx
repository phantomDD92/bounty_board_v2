...
const InfraCreatorView = () => {
  ...
  const handleDelete = () => {
    ...
    deleteInfraForUser(selected._id)
      .then(() => {
        toast.success(`Infra deleted successfully`);
        getInfraListForUser()
          .then(newData => {
            setData(newData)
          })
  ...
  return (
    <>
      <Card>
        <CardHeader title='Infra Submissions' className='pbe-4' />
...
export default InfraCreatorView
