...
import { getSocialListForUser, deleteSocialForUser } from '@/lib/api'

import type { SocialType } from '@/types/valueTypes'
...
const SocialCreatorView = () => {
  ...
  const handleDelete = () => {
    ...
    deleteSocialForUser(selected._id)
      .then(() => {
  ...
  return (
    <>
      <Card>
        <CardHeader title='Social Submissions' className='pbe-4' />
...
export default SocialCreatorView
